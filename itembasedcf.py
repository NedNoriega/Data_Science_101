...
ratings = pd.read_csv('D://Personal//00_P-Folder//08_Learning//Data Science and Machine Learning//DataScience//ml-100k//u.data', sep='\t', names=r_cols, usecols=range(3))

m_cols = ['movie_id', 'title']
movies = pd.read_csv('D://Personal//00_P-Folder//08_Learning//Data Science and Machine Learning//DataScience//ml-100k//u.item', sep='|', names=m_cols, usecols=range(2))
